    ...
    <>
      <div className="grid md:grid-cols-2 gap-14 justify-between w-full p-14">
        <div className="md:text-4xl text-3xl font-extrabold text-gray-700 md:mt-10">
          ...
          At MOCK-AI, we leverage advanced technologies and innovative tools to deliver a dynamic, AI-driven mock interview experience. Here’s an in-depth look at the key components that power MOCK-AI.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-3 p-5">
          <div className="bg-zinc-800 p-4 text-slate-200 md:h-[200px] rounded-xl shadow-md">
            ...
            <p className="text-md my-2">
              MOCK-AI is the Gemini AI, a powerful engine responsible for
          ...
          <div className="bg-zinc-800 p-4 text-slate-200 md:h-[200px] rounded-xl shadow-md">
            ...
            <p className="text-md my-2">
              MOCK-AI using Next.js, a powerful React framework that
